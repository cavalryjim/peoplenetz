...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/abstract_io_spec.rb", "spec/childprocess_spec.rb", "spec/io_spec.rb", "spec/jruby_spec.rb", "spec/pid_behavior.rb", "spec/spec_helper.rb", "spec/unix_spec.rb", "spec/windows_spec.rb"]
